...
var Vector4f.zyx get() = Vector3f(this.z, this.y, this.x); set(v) { this.z = v.x; this.y = v.y; this.x = v.z }
...
var Vector4f.xyzw get() = Vector4f(this.x, this.y, this.z, this.w); set(v) { this.x = v.x; this.y = v.y; this.z = v.z; this.w = v.w }
val Vector4f.xywx get() = Vector4f(this.x, this.y, this.w, this.x)
val Vector4f.xywy get() = Vector4f(this.x, this.y, this.w, this.y)
var Vector4f.xywz get() = Vector4f(this.x, this.y, this.w, this.z); set(v) { this.x = v.x; this.y = v.y; this.w = v.z; this.z = v.w }
...
val Vector4f.xzyz get() = Vector4f(this.x, this.z, this.y, this.z)
var Vector4f.xzyw get() = Vector4f(this.x, this.z, this.y, this.w); set(v) { this.x = v.x; this.z = v.y; this.y = v.z; this.w = v.w }
...
var Vector4f.xzwy get() = Vector4f(this.x, this.z, this.w, this.y); set(v) { this.x = v.x; this.z = v.y; this.w = v.z; this.y = v.w }
val Vector4f.xzwz get() = Vector4f(this.x, this.z, this.w, this.z)
val Vector4f.xzww get() = Vector4f(this.x, this.z, this.w, this.w)
...
val Vector4f.xwyw get() = Vector4f(this.x, this.w, this.y, this.w)
...
val Vector4f.xwzw get() = Vector4f(this.x, this.w, this.z, this.w)
...
val Vector4f.yxyz get() = Vector4f(this.y, this.x, this.y, this.z)
val Vector4f.yxyw get() = Vector4f(this.y, this.x, this.y, this.w)
val Vector4f.yxzx get() = Vector4f(this.y, this.x, this.z, this.x)
val Vector4f.yxzy get() = Vector4f(this.y, this.x, this.z, this.y)
...
val Vector4f.yxwy get() = Vector4f(this.y, this.x, this.w, this.y)
...
val Vector4f.yzxy get() = Vector4f(this.y, this.z, this.x, this.y)
...
val Vector4f.yzyx get() = Vector4f(this.y, this.z, this.y, this.x)
...
val Vector4f.yzwy get() = Vector4f(this.y, this.z, this.w, this.y)
val Vector4f.yzwz get() = Vector4f(this.y, this.z, this.w, this.z)
val Vector4f.yzww get() = Vector4f(this.y, this.z, this.w, this.w)
val Vector4f.ywxx get() = Vector4f(this.y, this.w, this.x, this.x)
val Vector4f.ywxy get() = Vector4f(this.y, this.w, this.x, this.y)
...
val Vector4f.ywyx get() = Vector4f(this.y, this.w, this.y, this.x)
...
val Vector4f.ywzy get() = Vector4f(this.y, this.w, this.z, this.y)
val Vector4f.ywzz get() = Vector4f(this.y, this.w, this.z, this.z)
val Vector4f.ywzw get() = Vector4f(this.y, this.w, this.z, this.w)
...
val Vector4f.zxyy get() = Vector4f(this.z, this.x, this.y, this.y)
val Vector4f.zxyz get() = Vector4f(this.z, this.x, this.y, this.z)
...
val Vector4f.zxwz get() = Vector4f(this.z, this.x, this.w, this.z)
val Vector4f.zxww get() = Vector4f(this.z, this.x, this.w, this.w)
val Vector4f.zyxx get() = Vector4f(this.z, this.y, this.x, this.x)
...
val Vector4f.zywy get() = Vector4f(this.z, this.y, this.w, this.y)
val Vector4f.zywz get() = Vector4f(this.z, this.y, this.w, this.z)
...
val Vector4f.zwxx get() = Vector4f(this.z, this.w, this.x, this.x)
var Vector4f.zwxy get() = Vector4f(this.z, this.w, this.x, this.y); set(v) { this.z = v.x; this.w = v.y; this.x = v.z; this.y = v.w }
val Vector4f.zwxz get() = Vector4f(this.z, this.w, this.x, this.z)
val Vector4f.zwxw get() = Vector4f(this.z, this.w, this.x, this.w)
var Vector4f.zwyx get() = Vector4f(this.z, this.w, this.y, this.x); set(v) { this.z = v.x; this.w = v.y; this.y = v.z; this.x = v.w }
val Vector4f.zwyy get() = Vector4f(this.z, this.w, this.y, this.y)
val Vector4f.zwyz get() = Vector4f(this.z, this.w, this.y, this.z)
val Vector4f.zwyw get() = Vector4f(this.z, this.w, this.y, this.w)
...
val Vector4f.wxxy get() = Vector4f(this.w, this.x, this.x, this.y)
val Vector4f.wxxz get() = Vector4f(this.w, this.x, this.x, this.z)
val Vector4f.wxxw get() = Vector4f(this.w, this.x, this.x, this.w)
val Vector4f.wxyx get() = Vector4f(this.w, this.x, this.y, this.x)
val Vector4f.wxyy get() = Vector4f(this.w, this.x, this.y, this.y)
var Vector4f.wxyz get() = Vector4f(this.w, this.x, this.y, this.z); set(v) { this.w = v.x; this.x = v.y; this.y = v.z; this.z = v.w }
val Vector4f.wxyw get() = Vector4f(this.w, this.x, this.y, this.w)
val Vector4f.wxzx get() = Vector4f(this.w, this.x, this.z, this.x)
var Vector4f.wxzy get() = Vector4f(this.w, this.x, this.z, this.y); set(v) { this.w = v.x; this.x = v.y; this.z = v.z; this.y = v.w }
val Vector4f.wxzz get() = Vector4f(this.w, this.x, this.z, this.z)
val Vector4f.wxzw get() = Vector4f(this.w, this.x, this.z, this.w)
...
val Vector4f.wyxx get() = Vector4f(this.w, this.y, this.x, this.x)
val Vector4f.wyxy get() = Vector4f(this.w, this.y, this.x, this.y)
var Vector4f.wyxz get() = Vector4f(this.w, this.y, this.x, this.z); set(v) { this.w = v.x; this.y = v.y; this.x = v.z; this.z = v.w }
val Vector4f.wyxw get() = Vector4f(this.w, this.y, this.x, this.w)
val Vector4f.wyyx get() = Vector4f(this.w, this.y, this.y, this.x)
...
val Vector4f.wyzy get() = Vector4f(this.w, this.y, this.z, this.y)
val Vector4f.wyzz get() = Vector4f(this.w, this.y, this.z, this.z)
val Vector4f.wyzw get() = Vector4f(this.w, this.y, this.z, this.w)
...
val Vector4f.wzxx get() = Vector4f(this.w, this.z, this.x, this.x)
var Vector4f.wzxy get() = Vector4f(this.w, this.z, this.x, this.y); set(v) { this.w = v.x; this.z = v.y; this.x = v.z; this.y = v.w }
val Vector4f.wzxz get() = Vector4f(this.w, this.z, this.x, this.z)
val Vector4f.wzxw get() = Vector4f(this.w, this.z, this.x, this.w)
var Vector4f.wzyx get() = Vector4f(this.w, this.z, this.y, this.x); set(v) { this.w = v.x; this.z = v.y; this.y = v.z; this.x = v.w }
val Vector4f.wzyy get() = Vector4f(this.w, this.z, this.y, this.y)
val Vector4f.wzyz get() = Vector4f(this.w, this.z, this.y, this.z)
val Vector4f.wzyw get() = Vector4f(this.w, this.z, this.y, this.w)
...
var Vector4f.bgr get() = Vector3f(this.z, this.y, this.x); set(v) { this.z = v.x; this.y = v.y; this.x = v.z }
...
var Vector4f.rgba get() = Vector4f(this.x, this.y, this.z, this.w); set(v) { this.x = v.x; this.y = v.y; this.z = v.z; this.w = v.w }
val Vector4f.rgar get() = Vector4f(this.x, this.y, this.w, this.x)
val Vector4f.rgag get() = Vector4f(this.x, this.y, this.w, this.y)
var Vector4f.rgab get() = Vector4f(this.x, this.y, this.w, this.z); set(v) { this.x = v.x; this.y = v.y; this.w = v.z; this.z = v.w }
...
val Vector4f.rbgb get() = Vector4f(this.x, this.z, this.y, this.z)
var Vector4f.rbga get() = Vector4f(this.x, this.z, this.y, this.w); set(v) { this.x = v.x; this.z = v.y; this.y = v.z; this.w = v.w }
...
var Vector4f.rbag get() = Vector4f(this.x, this.z, this.w, this.y); set(v) { this.x = v.x; this.z = v.y; this.w = v.z; this.y = v.w }
val Vector4f.rbab get() = Vector4f(this.x, this.z, this.w, this.z)
val Vector4f.rbaa get() = Vector4f(this.x, this.z, this.w, this.w)
...
val Vector4f.raga get() = Vector4f(this.x, this.w, this.y, this.w)
...
val Vector4f.grgb get() = Vector4f(this.y, this.x, this.y, this.z)
val Vector4f.grga get() = Vector4f(this.y, this.x, this.y, this.w)
val Vector4f.grbr get() = Vector4f(this.y, this.x, this.z, this.x)
val Vector4f.grbg get() = Vector4f(this.y, this.x, this.z, this.y)
...
val Vector4f.grag get() = Vector4f(this.y, this.x, this.w, this.y)
...
val Vector4f.gbrg get() = Vector4f(this.y, this.z, this.x, this.y)
...
val Vector4f.gbgr get() = Vector4f(this.y, this.z, this.y, this.x)
...
val Vector4f.gbag get() = Vector4f(this.y, this.z, this.w, this.y)
val Vector4f.gbab get() = Vector4f(this.y, this.z, this.w, this.z)
val Vector4f.gbaa get() = Vector4f(this.y, this.z, this.w, this.w)
val Vector4f.garr get() = Vector4f(this.y, this.w, this.x, this.x)
val Vector4f.garg get() = Vector4f(this.y, this.w, this.x, this.y)
...
val Vector4f.gagr get() = Vector4f(this.y, this.w, this.y, this.x)
...
val Vector4f.gabg get() = Vector4f(this.y, this.w, this.z, this.y)
val Vector4f.gabb get() = Vector4f(this.y, this.w, this.z, this.z)
val Vector4f.gaba get() = Vector4f(this.y, this.w, this.z, this.w)
...
val Vector4f.brgg get() = Vector4f(this.z, this.x, this.y, this.y)
val Vector4f.brgb get() = Vector4f(this.z, this.x, this.y, this.z)
...
val Vector4f.brab get() = Vector4f(this.z, this.x, this.w, this.z)
val Vector4f.braa get() = Vector4f(this.z, this.x, this.w, this.w)
val Vector4f.bgrr get() = Vector4f(this.z, this.y, this.x, this.x)
...
val Vector4f.bgag get() = Vector4f(this.z, this.y, this.w, this.y)
val Vector4f.bgab get() = Vector4f(this.z, this.y, this.w, this.z)
...
val Vector4f.barr get() = Vector4f(this.z, this.w, this.x, this.x)
var Vector4f.barg get() = Vector4f(this.z, this.w, this.x, this.y); set(v) { this.z = v.x; this.w = v.y; this.x = v.z; this.y = v.w }
val Vector4f.barb get() = Vector4f(this.z, this.w, this.x, this.z)
val Vector4f.bara get() = Vector4f(this.z, this.w, this.x, this.w)
var Vector4f.bagr get() = Vector4f(this.z, this.w, this.y, this.x); set(v) { this.z = v.x; this.w = v.y; this.y = v.z; this.x = v.w }
val Vector4f.bagg get() = Vector4f(this.z, this.w, this.y, this.y)
val Vector4f.bagb get() = Vector4f(this.z, this.w, this.y, this.z)
val Vector4f.baga get() = Vector4f(this.z, this.w, this.y, this.w)
...
val Vector4f.arrg get() = Vector4f(this.w, this.x, this.x, this.y)
val Vector4f.arrb get() = Vector4f(this.w, this.x, this.x, this.z)
val Vector4f.arra get() = Vector4f(this.w, this.x, this.x, this.w)
val Vector4f.argr get() = Vector4f(this.w, this.x, this.y, this.x)
val Vector4f.argg get() = Vector4f(this.w, this.x, this.y, this.y)
var Vector4f.argb get() = Vector4f(this.w, this.x, this.y, this.z); set(v) { this.w = v.x; this.x = v.y; this.y = v.z; this.z = v.w }
val Vector4f.arga get() = Vector4f(this.w, this.x, this.y, this.w)
val Vector4f.arbr get() = Vector4f(this.w, this.x, this.z, this.x)
var Vector4f.arbg get() = Vector4f(this.w, this.x, this.z, this.y); set(v) { this.w = v.x; this.x = v.y; this.z = v.z; this.y = v.w }
val Vector4f.arbb get() = Vector4f(this.w, this.x, this.z, this.z)
val Vector4f.arba get() = Vector4f(this.w, this.x, this.z, this.w)
...
val Vector4f.agrr get() = Vector4f(this.w, this.y, this.x, this.x)
val Vector4f.agrg get() = Vector4f(this.w, this.y, this.x, this.y)
...
val Vector4f.agbg get() = Vector4f(this.w, this.y, this.z, this.y)
val Vector4f.agbb get() = Vector4f(this.w, this.y, this.z, this.z)
val Vector4f.agba get() = Vector4f(this.w, this.y, this.z, this.w)
...
val Vector4f.abrr get() = Vector4f(this.w, this.z, this.x, this.x)
var Vector4f.abrg get() = Vector4f(this.w, this.z, this.x, this.y); set(v) { this.w = v.x; this.z = v.y; this.x = v.z; this.y = v.w }
val Vector4f.abrb get() = Vector4f(this.w, this.z, this.x, this.z)
val Vector4f.abra get() = Vector4f(this.w, this.z, this.x, this.w)
var Vector4f.abgr get() = Vector4f(this.w, this.z, this.y, this.x); set(v) { this.w = v.x; this.z = v.y; this.y = v.z; this.x = v.w }
val Vector4f.abgg get() = Vector4f(this.w, this.z, this.y, this.y)
val Vector4f.abgb get() = Vector4f(this.w, this.z, this.y, this.z)
val Vector4f.abga get() = Vector4f(this.w, this.z, this.y, this.w)
